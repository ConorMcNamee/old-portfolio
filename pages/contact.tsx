...
export default function Contact() {
    return (
        <section id="contact" className="h-screen flex flex-col text-center justify-center self-center ">
            ...
            <form className="flex flex-col h-[50%] py-20 w-[50%] justify-evenly self-center" method="post">
